...
from ui.splash.windows_cargas import Window_Carga
...
class SplashScreen(QWidget):
    def __init__(self,main_window):
        ...
        try:
            pixmap = QPixmap(os.path.join(os.path.dirname(__file__), "logo.png")).scaled(140, 140, Qt.AspectRatioMode.KeepAspectRatio,
